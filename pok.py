...
def license():
    try:
        ...
        print (M+' License Invalid !');time.sleep (1.0)
        os.system('clear')
...
def romz():
    ...
    idg.close()
    jalan ('\n'+U+' • '+O+'License'+M+' : '+H+'' + id+' ✓')
    jalan (U+' • '+M+'License Belum Di konfirmasi ')
    jalan (U+' • '+O+'Chat Admin Untuk Mengkonfirmasi License\x1b[1;39m')
    raw_input('\n'+U+' • '+O+'Tekan Enter ')
    os.system('am start https://wa.me/+62895341157823?text=Hai+RATU+beli+license%20dong:%20' + id + ' >/dev/null')
    time.sleep(1)
    os.sys.exit()
...
def user1():
    try:
        ...
        if j in r:
            ...
            logo_()
            tik()
            jalan('\n'+U+' •'+H+' License Tersedia ✓');time.sleep(1)
            menu()
        else:
            os.system('clear')
            logo_()
            tik()
            jalan ('\n'+U+' •'+M+' License Tidak Tersedia !');time.sleep(1)
            romz()
            jalan (U+' • '+O+'Chat Admin Untuk Mengkonfirmasi License\x1b[1;39m')
            raw_input('\n'+U+' • '+O+'Tekan Enter ')
            os.system('am start https://wa.me/+62895341157823?text=Hai+RATU+beli+license%20dong:%20' + j + ' >/dev/null')
            os.sys.exit()
...
def tik():
    titik = [
     '.   ', '..  ', '... ']
    for o in titik:
        print '\r\x1b[1;95m •\x1b[1;96m Memeriksa License ' + o,
        sys.stdout.flush()
        time.sleep(1)
def logo_():
	print (H+"\n  >_< \n")
...
#	os.system("mkdir /results")
  ...
  ┗┛┗━┻┛ ┗┛ ┗┛ ┗━━━┛ ┗━━━┻┛┗━┻┛┗━┻━━━┻┛┗━┛
 \x1b[1;97m-------------------------------------------
   \x1b[1;95mC     \x1b[1;92mO     \x1b[1;97mL     \x1b[1;93mM      \x1b[1;97mE     \x1b[1;92mX     \x1b[1;95mS
 \x1b[1;97m-------------------------------------------\033[0m\n""")	
def bot_komen():
    try:
...
def menu():
	...
	print(" "+p+"[*] User : "+k+user)
        print
	print("\x1b[1;93m* \x1b[1;92mLOE ASYIK GUE SANTAI LOE USIK GUE BANTAI \x1b[1;93m*")
	print
